...
from GitCallerStub import GitCallerStub
import json

class MyTestCase(unittest.TestCase):

    caller = GitCallerStub(None, None)
    wrapper = GitController(caller)
    ...
    def test_repoListCall(self):
        repoList = self.wrapper.getRepoList(None, None)
        assert repoList == self.repoListJson['value']
        
    def test_branchListCall(self):
        branchList = self.wrapper.getBranches(None, None, None)
        assert branchList == self.branchListJson['value']
